  ...
  return (
    <a
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = "0 8px 26px rgba(0, 0, 0, 0.24)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      >
        <span style={{ color: "#25D366", fontWeight: 800, fontSize: "15px" }}>
          WhatsApp
        </span>
        <span style={{ color: "#3a3a3a", fontWeight: 700, fontSize: "12px" }}>
          Click to Chat
        </span>
      </span>
    </a>
